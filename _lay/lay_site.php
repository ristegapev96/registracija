    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo PAGE  . 'home' ?>">Почетна</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo PAGE  . 'post_login/dashboard' ?>">Dashboard</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo PAGE  . 'galerija' ?>">Галерија</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo PAGE  . 'post_login/membership' ?>">Membership</a>
          </li>
            <li class="nav-item">
            <a class="nav-link" href="<?php echo PAGE  . 'post_login/Users' ?>">Users</a>
          </li>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="<?php echo PAGE  . 'post_login/allusers' ?>">All Users</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo PAGE  . 'post_login/korekcija' ?>">Korekcija</a>
          </li>
          
          <!--- <li class="nav-item">
            <a class="nav-link" href="galerii/?id=<?php echo $_SESSION['userID'];?>" target="_blank">Податоци</a>
          </li>
...
document.write("&copy; 2020"); //+ year );
// End

</script>
 &nbsp;<a href="#" TARGET="_new">#</a>.&nbsp;&nbsp;&nbsp; <span style="font-style: italic; font-size: small; float: right;"></span>
</p>
</div>
</footer>
 ...
 <!-- Bootstrap Core JavaScript
    ...
    <script src="assets/js/jquery-3.4.1.slim.min.js"><\/script>')</script>  
